...
- I used copilot agents a lot and so you will see some tell tale signs and excessive logging with emoticons. i prefer having self documenting code to comments (other than the "why" type of thing which i capture in comments) and less logging, or at least use log levels, but i didnt think it was important to go back and clean it all up.
